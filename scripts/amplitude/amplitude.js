(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else if (typeof exports === "object") exports["Amplitude"] = factory();
  else root["Amplitude"] = factory();
})(this, function () {
  return /******/ (function (modules) {
    ...
    */
            ...
            _config2.default.audio.playbackRate =
              _config2.default.playback_speed;
          }
    ...
    */
            if (!_config2.default.active_metadata.live) {
              _config2.default.audio.currentTime =
                _config2.default.audio.duration * (songPercentage / 100);
            }
          }
    ...
    */
            _config2.default.audio.addEventListener(
              "canplaythrough",
              function () {
                /*
  ...
  */
    ...
    */
            var playPauseElements = document.querySelectorAll(
    ...
    */
      ...
      */
              var playlist = playPauseElements[i].getAttribute(
                "data-amplitude-playlist"
              );
              var song = playPauseElements[i].getAttribute(
    ...
    */
            var playlistPlayPauseElements = document.querySelectorAll(
    ...
    */
      ...
      */
              var song = playlistPlayPauseElements[i].getAttribute(
                "data-amplitude-song-index"
              );
    ...
    */
            var songPlayPauseElements = document.querySelectorAll(
    ...
    */
      ...
      */
              var playlist = songPlayPauseElements[i].getAttribute(
                "data-amplitude-playlist"
              );
          ...
          function syncSongInPlaylist() {
            ...
            var activePlaylistIndex =
              ...
              _config2.default.active_playlist != null
                ? _config2.default.playlists[_config2.default.active_playlist]
                    .active_index
                : null;
    ...
    */
            var songInPlaylistPlayPauseElements = document.querySelectorAll(
              '.amplitude-play-pause[data-amplitude-song-index="' +
                activePlaylistIndex +
                '"][data-amplitude-playlist="' +
                _config2.default.active_playlist +
    ...
    */
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var _songPlayedProgressElements2 = _interopRequireDefault(
          _songPlayedProgressElements
        );
    ...
    */
      ...
      */
              if (_config2.default.shuffle_on) {
                nextIndex =
                  _config2.default.shuffle_list[_config2.default.active_index]
                    .index;
      ...
      */
        ...
        */
                if (
                  parseInt(_config2.default.active_index) + 1 <
                  _config2.default.shuffle_list.length
                ) {
                  /*
    ...
    */
      ...
      */
              if (_config2.default.playlists[playlist].shuffle) {
                ...
                nextSong =
                  _config2.default.playlists[playlist].shuffle_list[nextIndex];
              } else {
                nextIndex = _config2.default.playlists[playlist].active_index;
                nextSong =
                  _config2.default.playlists[playlist].songs[nextIndex];
              }
            } else {
              /*
      ...
      */
        ...
        */
                if (
                  parseInt(_config2.default.playlists[playlist].active_index) +
                    1 <
                  _config2.default.playlists[playlist].shuffle_list.length
                ) {
                  /*
            Set the next index to be the index of the song in the shuffle list.
          */
                  nextIndex =
                    _config2.default.playlists[playlist].active_index + 1;
                } else {
                  nextIndex = 0;
                  endOfList = true;
                }
        ...
        */
                if (
                  parseInt(_config2.default.playlists[playlist].active_index) +
                    1 <
                  _config2.default.playlists[playlist].songs.length
                ) {
                  nextIndex =
                    parseInt(
                      _config2.default.playlists[playlist].active_index
                    ) + 1;
                } else {
                  nextIndex = 0;
                  endOfList = true;
    ...
    */
      ...
      */
              if (_config2.default.playlists[playlist].shuffle) {
                ...
                previousIndex =
                  _config2.default.playlists[playlist].active_index;
                previousSong =
                  _config2.default.playlists[playlist].songs[previousIndex];
              }
            } else {
              /*
        Get the previous index. If the previous index will be less than 0, get the
      ...
      */
              if (
                ...
                previousIndex = parseInt(
                  _config2.default.playlists[playlist].active_index - 1
                );
              } else {
                previousIndex = parseInt(
                  _config2.default.playlists[playlist].songs.length - 1
                );
              }
  ...
  */
    ...
    */
            var songInfoElements = document.querySelectorAll(
    ...
    */
      ...
      key.
      */
              var info = songInfoElements[i].getAttribute(
                "data-amplitude-song-info"
              );
      ...
      */
              var playlist = songInfoElements[i].getAttribute(
                "data-amplitude-playlist"
              );
              var songIndex = songInfoElements[i].getAttribute(
                "data-amplitude-song-index"
              );
      ...
      */
        ...
        */
                var val =
                  _config2.default.active_metadata[info] != undefined
                    ? _config2.default.active_metadata[info]
                    : null;
    ...
    */
            var playlistInfoElements = document.querySelectorAll(
    ...
    */
      ...
      key.
      */
              var info = playlistInfoElements[i].getAttribute(
                "data-amplitude-playlist-info"
              );
              var playlist = playlistInfoElements[i].getAttribute(
                "data-amplitude-playlist"
              );
              ...
              if (_config2.default.playlists[playlist][info] != undefined) {
                if (imageMetaDataKeys.indexOf(info) >= 0) {
                  playlistInfoElements[i].setAttribute(
                    "src",
                    _config2.default.playlists[playlist][info]
                  );
                } else {
    ...
    */
      ...
      */
              var elementPlaylist = songInfoElements[i].getAttribute(
                "data-amplitude-playlist"
              );
    ...
    */
        ...
        */
                var val =
                  _config2.default.songs[songIndex][info] != undefined
                    ? _config2.default.songs[songIndex][info]
                    : null;
                /*
      ...
      */
        ...
        */
                var _info = songInfoElements[i].getAttribute(
                  "data-amplitude-song-info"
                );
        ...
        */
                if (
                  _config2.default.playlists[playlist].songs[songIndex][
                    _info
                  ] != undefined
                ) {
    ...
    */
            var repeatClasses = document.getElementsByClassName(
              "amplitude-repeat"
            );
    ...
    */
            var repeatButtons = document.getElementsByClassName(
              "amplitude-repeat"
            );
    ...
    */
      ...
      */
              if (
                repeatButtons[i].getAttribute("data-amplitude-playlist") ==
                playlist
              ) {
                /*
    ...
    */
            var repeatSongClasses = document.getElementsByClassName(
    ...
    */
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var VolumeSliderElements = (function () {
           ...
           */
          function sync() {
            var volumeSliders = document.getElementsByClassName(
  ...
  */
    ...
    */
            for (var _i = _config2.default.songs.length - 1; _i > 0; _i--) {
              var randNum = Math.floor(
                Math.random() * _config2.default.songs.length + 1
              );
    ...
    */
            for (
              var i = 0;
              i < _config2.default.playlists[playlist].songs.length;
              i++
            ) {
    ...
    */
            for (
              var _i2 = _config2.default.playlists[playlist].songs.length - 1;
              _i2 > 0;
              _i2--
            ) {
              var randNum = Math.floor(
    ...
    */
            var mainSongSliders = document.querySelectorAll(
    ...
    */
        ...
        Grab the playlist and song attributes from the element.
      */
              var playlist = mainSongSliders[i].getAttribute(
                "data-amplitude-playlist"
              );
              var song = mainSongSliders[i].getAttribute(
                "data-amplitude-song-index"
              );
    ...
    */
            var playlistSongSliders = document.querySelectorAll(
    ...
    */
        ...
        Grab the playlist and song attributes from the element.
      */
              var playlistAttribute = playlistSongSliders[i].getAttribute(
                "data-amplitude-playlist"
              );
              var songAttribute = playlistSongSliders[i].getAttribute(
                "data-amplitude-song-index"
              );
    ...
    */
      ...
      */
              var songSliders = document.querySelectorAll(
      ...
      */
         ...
         Grab the playlist and song attributes from the element.
        */
                var playlistAttribute = songSliders[i].getAttribute(
                  "data-amplitude-playlist"
                );
                var songAttribute = songSliders[i].getAttribute(
                  "data-amplitude-song-index"
                );
    ...
    */
            var songInPlaylistSliders = document.querySelectorAll(
              '.amplitude-song-slider[data-amplitude-playlist="' +
                playlist +
                '"][data-amplitude-song-index="' +
                activePlaylistIndex +
    ...
    */
          ...
          function resetElements() {
            var songSliders = document.getElementsByClassName(
              "amplitude-song-slider"
            );
    ...
    */
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var _currentTimeElements2 = _interopRequireDefault(
          _currentTimeElements
        );

        var _currentHourElements = __webpack_require__(50);

        var _currentHourElements2 = _interopRequireDefault(
          _currentHourElements
        );

        var _currentMinuteElements = __webpack_require__(51);

        var _currentMinuteElements2 = _interopRequireDefault(
          _currentMinuteElements
        );

        var _currentSecondElements = __webpack_require__(52);

        var _currentSecondElements2 = _interopRequireDefault(
          _currentSecondElements
        );

        var _durationCountDownTimeElements = __webpack_require__(54);

        var _durationCountDownTimeElements2 = _interopRequireDefault(
          _durationCountDownTimeElements
        );

        var _durationHourElements = __webpack_require__(55);

        var _durationHourElements2 = _interopRequireDefault(
          _durationHourElements
        );

        var _durationMinuteElements = __webpack_require__(56);

        var _durationMinuteElements2 = _interopRequireDefault(
          _durationMinuteElements
        );

        var _durationSecondElements = __webpack_require__(57);

        var _durationSecondElements2 = _interopRequireDefault(
          _durationSecondElements
        );

        var _durationTimeElements = __webpack_require__(58);

        var _durationTimeElements2 = _interopRequireDefault(
          _durationTimeElements
        );
        ...
        var TimeElements = (function () {
          ...
          function syncDurationTimes(currentTime, songDuration) {
            _durationCountDownTimeElements2.default.sync(
              currentTime,
              songDuration
            );
    ...
    */
            var visualizationElements = document.querySelectorAll(
    ...
    */
      ...
      */
              if (
                Object.keys(_config2.default.visualizations.available).length >
                  0 &&
          ...
          */
            ...
            */
                  var playlist = visualizationElements[i].getAttribute(
                    "data-amplitude-playlist"
                  );
                  var song = visualizationElements[i].getAttribute(
                    "data-amplitude-song-index"
                  );
    ...
    */
            ...
            var activeSongVisualizationIndex =
              _config2.default.active_index != null
                ? _config2.default.songs[_config2.default.active_index]
                    .visualization
                : _config2.default.playlists[_config2.default.active_playlist]
                    .songs[
                    _config2.default.playlists[_config2.default.active_playlist]
    ...
    */
            if (
              ...
              _config2.default.visualizations.available[
      ...
      */
              var firstVisualization =
                Object.keys(_config2.default.visualizations.available).length >
                0
                  ? Object.keys(_config2.default.visualizations.available)[0]
                  : null;
    ...
    */
      ...
      */
              ...
              var activePlaylistVisualizationIndex =
                _config2.default.playlists[_config2.default.active_playlist]
                  .visualization;
              var globalVisualizationIndex = _config2.default.visualization;
      ...
      */
        ...
        */
                ...
                _config2.default.visualizations.available[
                  activePlaylistVisualizationIndex
                ] != undefined
              ) {
                addToActiveVisualizations(
                  activePlaylistVisualizationIndex,
        ...
        */
                var firstVisualization =
                  Object.keys(_config2.default.visualizations.available)
                    .length > 0
                    ? Object.keys(_config2.default.visualizations.available)[0]
                    : null;
    ...
    */
            if (
              playlist == _config2.default.active_playlist &&
              _config2.default.playlists[playlist].active_index == song
            ) {
              /*
        Checks if the song has a visualization and that visualization exists,
        run that visualization.
      ...
      */
        ...
        */
          ...
          function addToActiveVisualizations(key, element) {
            var visualization = new _config2.default.visualizations.available[
              key
            ]["object"]();
            visualization.setPreferences(
              _config2.default.visualizations.available[key]["preferences"]
            );
    ...
    */
            for (
              var i = 0;
              i < _config2.default.visualizations.active.length;
              i++
            ) {
    ...
    */
            _config2.default.visualizations.available[
              newVisualization.getID()
            ] = new Array();
            _config2.default.visualizations.available[newVisualization.getID()][
              "object"
            ] = visualization;
            _config2.default.visualizations.available[newVisualization.getID()][
              "preferences"
    ...
    */
          ...
          determine which one we run.
        */
                var playlist = visualizationElements[x].getAttribute(
                  "data-amplitude-playlist"
                );
                var song = visualizationElements[x].getAttribute(
                  "data-amplitude-song-index"
                );
        ...
        */
                if (playlist != null && song != null) {
                  displaySongInPlaylistBackup(
                    visualizationElements[x],
                    playlist,
                    song
                  );
                }
          ...
          function displayGlobalBackup(element) {
            element.style.backgroundImage =
              "url(" + _config2.default.active_metadata.cover_art_url + ")";
          }
          ...
          function displaySongInPlaylistBackup(element, playlist, song) {
            if (
              _config2.default.active_playlist == playlist &&
              _config2.default.playlists[active_playlist].active_index == song
            ) {
              element.style.backgroundImage =
                "url(" + _config2.default.active_metadata.cover_art_url + ")";
            }
  ...
  */
    ...
    */
      ...
      */
              if (sound.streamable) {
                if (playlist != null) {
                  _config2.default.playlists[playlist].songs[index].url =
                    sound.stream_url +
                    "?client_id=" +
                    _config2.default.soundcloud_client;
          ...
          */
                  if (_config2.default.soundcloud_use_art) {
                    _config2.default.playlists[playlist].songs[
                      index
                    ].cover_art_url = sound.artwork_url;
          ...
          */
                  ...
                  _config2.default.songs[index].url =
                    sound.stream_url +
                    "?client_id=" +
                    _config2.default.soundcloud_client;

                  if (addToShuffleList) {
                    _config2.default.shuffle_list[index].stream_url +
                      "?client_id=" +
                      _config2.default.soundcloud_client;
                  }
          ...
          */
                  if (_config2.default.soundcloud_use_art) {
                    _config2.default.songs[index].cover_art_url =
                      sound.artwork_url;

                    if (addToShuffleList) {
                      _config2.default.shuffle_list[index].cover_art_url =
                        sound.artwork_url;
                    }
                  }
          ...
          */
                ...
                if (playlist != null) {
                  AmplitudeHelpers.writeDebugMessage(
                    _config2.default.playlists[playlist].songs[index].name +
                      " by " +
                      _config2.default.playlists[playlist].songs[index].artist +
          ...
          */
                  AmplitudeHelpers.writeDebugMessage(
                    _config2.default.songs[index].name +
                      " by " +
                      _config2.default.songs[index].artist +
                      " is not streamable by the Soundcloud API"
                  );
                }
              }
  ...
  */
    ...
    */
            var playbackSpeedClasses = document.getElementsByClassName(
    ...
    */
      ...
      */
              playbackSpeedClasses[i].classList.remove(
      ...
      */
              switch (_config2.default.playback_speed) {
                case 1:
                  playbackSpeedClasses[i].classList.add(
                    "amplitude-playback-speed-10"
                  );
                  break;
                case 1.5:
    ...
    */
            var shuffleButtons = document.getElementsByClassName(
              "amplitude-shuffle"
            );
    ...
    */
      ...
      */
              if (
                shuffleButtons[i].getAttribute("data-amplitude-playlist") ==
                null
              ) {
                /*
    ...
    */
            var shuffleButtons = document.querySelectorAll(
    ...
    */
      ...
      */
              var songPlayedProgressBars = document.querySelectorAll(
                ".amplitude-song-played-progress"
              );

              for (var i = 0; i < songPlayedProgressBars.length; i++) {
                var playlist = songPlayedProgressBars[i].getAttribute(
                  "data-amplitude-playlist"
                );
                var songIndex = songPlayedProgressBars[i].getAttribute(
                  "data-amplitude-song-index"
                );
    ...
    */
      ...
      */
              ...
              for (var i = 0; i < songPlayedProgressBars.length; i++) {
                var song = songPlayedProgressBars[i].getAttribute(
                  "data-amplitude-song-index"
                );
    ...
    */
      ...
      */
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var _volumeSliderElements2 = _interopRequireDefault(
          _volumeSliderElements
        );
        ...
        var _playbackSpeedElements2 = _interopRequireDefault(
          _playbackSpeedElements
        );
    ...
    */
            _config2.default.debug =
              userConfig.debug != undefined ? userConfig.debug : false;
    ...
    */
        ...
        */
                if (
                  ...
                  _config2.default.waveforms.sample_rate =
                    userConfig.waveforms.sample_rate;
                }
        ...
        */
              ...
              */
                  for (var i = 0; i < userConfig.visualizations.length; i++) {
                    _visualizations2.default.register(
    ...
    */
      ...
      */
              _config2.default.soundcloud_use_art =
    ...
    */
            if (
              userConfig.playlists &&
              countPlaylists(userConfig.playlists) > 0
            ) {
    ...
    */
            if (
              userConfig.start_song != undefined &&
      ...
      */
              if (_checks2.default.isInt(userConfig.start_song)) {
                _audioNavigation2.default.changeSong(
                  _config2.default.songs[userConfig.start_song],
    ...
    */
            if (userConfig.shuffle_on != undefined && userConfig.shuffle_on) {
              ...
              _audioNavigation2.default.changeSong(
                _config2.default.shuffle_list[0],
                0
              );
            }
    ...
    */
            _config2.default.continue_next =
              userConfig.continue_next != undefined
    ...
    */
            _config2.default.playback_speed =
              userConfig.playback_speed != undefined
    ...
    */
    ...
    load the metadata.
    */
            _config2.default.audio.preload =
    ...
    */
    ...
    by the user.
    */
            _config2.default.volume =
              userConfig.volume != undefined ? userConfig.volume : 50;

            /*
    Sets the delay between songs if the user has it set. This should be in MS.
    */
            _config2.default.delay =
              userConfig.delay != undefined ? userConfig.delay : 0;
    ...
    or decrease of 5.
    */
            _config2.default.volume_increment =
              userConfig.volume_increment != undefined
                ? userConfig.volume_increment
                : 5;

            _config2.default.volume_decrement =
    ...
    */
            if (userConfig.default_playlist_art != undefined) {
              _config2.default.default_playlist_art =
                userConfig.default_playlist_art;
            } else {
              _config2.default.default_playlist_art = "";
            }
          }
    ...
    */
    ...
    Sync Mute Elements.
    */
            _muteElements2.default.setMuted(
              _config2.default.volume == 0 ? true : false
            );
    ...
    */
            _debug2.default.writeMessage(
              "You have " + size + " playlist(s) in your config"
            );
  ...
  */
    ...
    */
      ...
      */
              if (
                _config2.default.waveforms.built[
                  Math.abs(
                    _config2.default.audio.src
                      .split("")
                      .reduce(function (a, b) {
        ...
        */
          ...
          */
            ...
            */
              ...
              */
                      _config2.default.context.decodeAudioData(
                        req.response,
    ...
    */
      ...
      */
              _config2.default.waveforms.built[
                Math.abs(
                  _config2.default.audio.src.split("").reduce(function (a, b) {
                    a = (a << 5) - a + b.charCodeAt(0);
                    return a & a;
                  }, 0)
                )
    ...
    */
      ...
      */
        ...
        */
                ...
                if (
                  channelNumber === 0 ||
                  min < mergedPeaks[2 * peakNumber + 1]
                ) {
    ...
    */
          ...
          function displayWaveForms(svg) {
            var waveformElements = document.querySelectorAll(
              ".amplitude-wave-form"
            );
    ...
    */
      ...
      */
              var playlist = waveformElements[i].getAttribute(
                "data-amplitude-playlist"
              );
      ...
      */
              var song = waveformElements[i].getAttribute(
                "data-amplitude-song-index"
              );
  ...
  */
    ...
    */
            var currentSeconds =
              (Math.floor(_config2.default.audio.currentTime % 60) < 10
                ? "0"
                : "") + Math.floor(_config2.default.audio.currentTime % 60);

            /*
    Computes the current minutes for the song.
    */
            var currentMinutes = Math.floor(
              _config2.default.audio.currentTime / 60
            );
    ...
    */
            var songDurationSeconds =
              (Math.floor(_config2.default.audio.duration % 60) < 10
                ? "0"
                : "") + Math.floor(_config2.default.audio.duration % 60);

            /*
    Computes the duration of the song's minutes.
    */
            var songDurationMinutes = Math.floor(
              _config2.default.audio.duration / 60
            );
    ...
    */
          ...
          function computeSongCompletionPercentage() {
            return (
              (_config2.default.audio.currentTime /
                _config2.default.audio.duration) *
              100
            );
          }
    ...
    */
            var songBufferedProgressBars = document.getElementsByClassName(
    ...
    */
            for (var i = 0; i < songBufferedProgressBars.length; i++) {
              var playlist = songBufferedProgressBars[i].getAttribute(
                "data-amplitude-playlist"
              );
              var song = songBufferedProgressBars[i].getAttribute(
                "data-amplitude-song-index"
              );

              if (playlist == null && song == null) {
                songBufferedProgressBars[i].value = parseFloat(
                  parseFloat(_config2.default.buffered) / 100
                );
              }
            }
          }
    ...
    Gets all of the song buffered progress bars.
    */
            var songBufferedProgressBarsPlaylist = document.querySelectorAll(
    ...
    */
            for (var i = 0; i < songBufferedProgressBarsPlaylist.length; i++) {
              var song = songBufferedProgressBarsPlaylist[i].getAttribute(
                "data-amplitude-song-index"
              );
    ...
    Gets all of the song buffered progress bars.
    */
            var songBufferedProgressBarsSongs = document.querySelectorAll(
    ...
    */
            for (var i = 0; i < songBufferedProgressBarsSongs.length; i++) {
              var playlist = songBufferedProgressBarsSongs[i].getAttribute(
                "data-amplitude-playlist"
              );
    ...
    Gets all of the song buffered progress bars.
    */
            var songBufferedProgressBarsSongsInPlaylist = document.querySelectorAll(
              '.amplitude-buffered-progress[data-amplitude-song-index="' +
                activePlaylistIndex +
                '"][data-amplitude-playlist="' +
                _config2.default.active_playlist +
    ...
    */
            for (
              var i = 0;
              i < songBufferedProgressBarsSongsInPlaylist.length;
              i++
            ) {
      ...
      */
        ...
        */
                if (
                  ...
                  _audioNavigation2.default.setNextPlaylist(
                    _config2.default.active_playlist,
                    true
                  );
                }
  ...
  */
    ...
    */
            _config2.default.audio.removeEventListener(
              "timeupdate",
              _timeUpdate2.default.handle
            );
            _config2.default.audio.addEventListener(
              "timeupdate",
              _timeUpdate2.default.handle
    ...
    */
            for (var i = 0; i < play_classes.length; i++) {
              if (
                ...
                play_classes[i].removeEventListener(
                  "touchend",
                  _play2.default.handle
                );
                play_classes[i].addEventListener(
                  "touchend",
                  _play2.default.handle
                );
              } else {
    ...
    */
            var pause_classes = document.getElementsByClassName(
              "amplitude-pause"
            );
    ...
    */
            for (var i = 0; i < pause_classes.length; i++) {
              if (
                ...
                pause_classes[i].removeEventListener(
                  "touchend",
                  _pause2.default.handle
                );
                pause_classes[i].addEventListener(
                  "touchend",
                  _pause2.default.handle
                );
              } else {
    ...
    */
            for (var i = 0; i < play_pause_classes.length; i++) {
              if (
                ...
                play_pause_classes[i].removeEventListener(
                  "touchend",
                  _playPause2.default.handle
                );
                play_pause_classes[i].addEventListener(
                  "touchend",
                  _playPause2.default.handle
                );
              } else {
    ...
    */
            var stop_classes = document.getElementsByClassName(
              "amplitude-stop"
            );
    ...
    */
            for (var i = 0; i < stop_classes.length; i++) {
              if (
                ...
                stop_classes[i].removeEventListener(
                  "touchend",
                  _stop2.default.handle
                );
                stop_classes[i].addEventListener(
                  "touchend",
                  _stop2.default.handle
                );
              } else {
      ...
      */
        ...
        */
                if (/iPhone|iPad|iPod/i.test(navigator.userAgent)) {
                  ...
                  mute_classes[i].removeEventListener(
                    "touchend",
                    _mute2.default.handle
                  );
                  mute_classes[i].addEventListener(
                    "touchend",
                    _mute2.default.handle
                  );
                }
      ...
      */
        ...
        */
                if (/iPhone|iPad|iPod/i.test(navigator.userAgent)) {
                  ...
                  volume_up_classes[i].removeEventListener(
                    "touchend",
                    _volumeUp2.default.handle
                  );
                  volume_up_classes[i].addEventListener(
                    "touchend",
                    _volumeUp2.default.handle
                  );
                }
    ...
    */
            var song_sliders = document.getElementsByClassName(
              "amplitude-song-slider"
            );
    ...
    */
            for (var i = 0; i < song_sliders.length; i++) {
              if (
                ...
                song_sliders[i].removeEventListener(
                  "change",
                  _songSlider2.default.handle
                );
                song_sliders[i].addEventListener(
                  "change",
                  _songSlider2.default.handle
                );
              } else {
    ...
    */
      ...
      */
              if (/iPhone|iPad|iPod/i.test(navigator.userAgent)) {
                ...
                if (
                  ...
                  volume_sliders[i].removeEventListener(
                    "change",
                    _volumeSlider2.default.handle
                  );
                  volume_sliders[i].addEventListener(
                    "change",
                    _volumeSlider2.default.handle
                  );
                } else {
    ...
    Gets all of the elements with the class amplitude-next
        */
            var next_classes = document.getElementsByClassName(
              "amplitude-next"
            );
    ...
    */
            for (var i = 0; i < next_classes.length; i++) {
              if (
                ...
                next_classes[i].removeEventListener(
                  "touchend",
                  _next2.default.handle
                );
                next_classes[i].addEventListener(
                  "touchend",
                  _next2.default.handle
                );
              } else {
    ...
    */
            var prev_classes = document.getElementsByClassName(
              "amplitude-prev"
            );
    ...
    */
            for (var i = 0; i < prev_classes.length; i++) {
              if (
                ...
                prev_classes[i].removeEventListener(
                  "touchend",
                  _prev2.default.handle
                );
                prev_classes[i].addEventListener(
                  "touchend",
                  _prev2.default.handle
                );
              } else {
    ...
    */
            var shuffle_classes = document.getElementsByClassName(
              "amplitude-shuffle"
            );
    ...
    */
      ...
      */
              ...
              if (
                ...
                shuffle_classes[i].removeEventListener(
                  "touchend",
                  _shuffle2.default.handle
                );
                shuffle_classes[i].addEventListener(
                  "touchend",
                  _shuffle2.default.handle
                );
              } else {
    ...
    */
            var repeat_classes = document.getElementsByClassName(
              "amplitude-repeat"
            );
    ...
    */
      ...
      */
              ...
              if (
                ...
                repeat_classes[i].removeEventListener(
                  "touchend",
                  _repeat2.default.handle
                );
                repeat_classes[i].addEventListener(
                  "touchend",
                  _repeat2.default.handle
                );
              } else {
      ...
      */
              ...
              if (
                ...
                repeat_song_classes[i].removeEventListener(
                  "touchend",
                  _repeatSong2.default.handle
                );
                repeat_song_classes[i].addEventListener(
                  "touchend",
                  _repeatSong2.default.handle
                );
              } else {
            ...
            for (var i = 0; i < playback_speed_classes.length; i++) {
              if (
                ...
                playback_speed_classes[i].removeEventListener(
                  "touchend",
                  _playbackSpeed2.default.handle
                );
    ...
    */
            var skipToClasses = document.getElementsByClassName(
              "amplitude-skip-to"
            );
    ...
    */
            for (var i = 0; i < skipToClasses.length; i++) {
              if (
                ...
                skipToClasses[i].removeEventListener(
                  "touchend",
                  _skipTo2.default.handle
                );
                skipToClasses[i].addEventListener(
                  "touchend",
                  _skipTo2.default.handle
                );
              } else {
...
*/
    ...
    */
            if (
              ...
              _audioNavigation2.default.setPreviousPlaylist(
                _config2.default.active_playlist
              );
            }
          }
    ...
    */
            if (
              ...
              _shuffler2.default.toggleShufflePlaylist(
                _config2.default.active_playlist
              );
            }
          }
  ...
  */
    ...
    */
        ...
        class.
      */
              var songIndexAttribute = this.getAttribute(
                "data-amplitude-song-index"
              );
              var playlistAttribute = this.getAttribute(
                "data-amplitude-playlist"
              );
    ...
    */
            if (
              (_config2.default.active_playlist == "" ||
                _config2.default.active_playlist == null) &&
              _config2.default.active_index == song
            ) {
              /*
        Pauses the song.
      */
  ...
  */
    ...
    */
      ...
      */
              if (_config2.default.playlists[playlist].shuffle) {
                _audioNavigation2.default.changeSongPlaylist(
                  playlist,
                  _config2.default.playlists[playlist].shuffle_list[0],
                  0
                );
              } else {
                _audioNavigation2.default.changeSongPlaylist(
                  playlist,
                  _config2.default.playlists[playlist].songs[0],
                  0
                );
              }
            }
    ...
    */
      ...
      */
              _audioNavigation2.default.changeSongPlaylist(
                playlist,
                _config2.default.playlists[playlist].songs[song],
                song
              );
            }
  ...
  */
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var _bufferedProgressElements2 = _interopRequireDefault(
          _bufferedProgressElements
        );
    ...
    */
            if (_config2.default.audio.buffered.length - 1 >= 0) {
              var bufferedEnd = _config2.default.audio.buffered.end(
                _config2.default.audio.buffered.length - 1
              );
    ...
    */
            _repeater2.default.setRepeatPlaylist(
              !_config2.default.playlists[playlist].repeat,
              playlist
            );
  ...
  */
    ...
    */
            _audioNavigation2.default.changeSong(
              _config2.default.songs[songIndex],
              songIndex
            );
            _core2.default.play();
    ...
    */
            var computedTime =
              _config2.default.audio.duration * (locationPercentage / 100);
    ...
    */
      ...
      */
              _songSliderElements2.default.sync(
                locationPercentage,
                _config2.default.active_playlist,
                _config2.default.active_index
              );
    ...
    */
            if (
              _config2.default.active_index == songIndex &&
              _config2.default.active_playlist == null
            ) {
              /*
      If the active song is not live, set the current time
  ...
  */
    ...
    */
      ...
      */
              _songPlayedProgressElements2.default.sync(
                songCompletionPercentage
              );
      ...
      */
              _timeElements2.default.syncDurationTimes(
                currentTime,
                songDuration
              );
            }
    ...
    */
            if (
              _config2.default.active_metadata.time_callbacks != undefined &&
      ...
      */
              if (
                ...
                _config2.default.active_metadata.time_callbacks[
                  currentSeconds
                ].run = true;
                _config2.default.active_metadata.time_callbacks[
                  currentSeconds
      ...
      */
              for (var seconds in _config2.default.active_metadata
                .time_callbacks) {
                if (
                  _config2.default.active_metadata.time_callbacks.hasOwnProperty(
                    seconds
                  )
                ) {
                  _config2.default.active_metadata.time_callbacks[
    ...
    */
      ...
      */
              ...
              if (
                _config2.default.volume - _config2.default.volume_increment >
                0
              ) {
                volume =
                  _config2.default.volume - _config2.default.volume_increment;
    ...
    */
      ...
      */
              _config2.default.source = _config2.default.context.createMediaElementSource(
                _config2.default.audio
              );
      ...
      */
              _config2.default.analyser.connect(
                _config2.default.context.destination
              );
            } else {
              AmplitudeHelpers.writeDebugMessage(
  ...
  */
    ...
    */
      ...
      */
              _config2.default.audio.currentTime =
                _config2.default.audio.duration * (percentage / 100);
            }
          }
    ...
    */
            ...
            if (_soundcloud2.default.isSoundCloudURL(song.url)) {
              _soundcloud2.default.resolveIndividualStreamableURL(
                song.url,
                null,
                _config2.default.songs.length - 1,
                _config2.default.shuffle_on
              );
            }
            ...
            if (_config2.default.playlists[playlist] != undefined) {
              ...
              if (_soundcloud2.default.isSoundCloudURL(song.url)) {
                _soundcloud2.default.resolveIndividualStreamableURL(
                  ...
                  playlist,
                  _config2.default.playlists[playlist].songs.length - 1,
                  _config2.default.playlists[playlist].shuffle
                );
              }
    ...
    */
            if (_checks2.default.newPlaylist(playlist)) {
              ...
              _audioNavigation2.default.changeSongPlaylist(
                playlist,
                _config2.default.playlists[playlist].songs[index],
                index
              );
            }
    ...
    */
            if (
              playlist != "" &&
              playlist != null &&
              _config2.default.playlists[playlist] != undefined
            ) {
              /*
              ...
              for (var key in metaData) {
                if (metaData.hasOwnProperty(key)) {
                  if (
                    ...
                    _config2.default.playlists[playlist].songs[index][key] =
                      metaData[key];
                  }
                }
              }
    ...
    */
      ...
      */
          ...
          function setPlaylistVisualization(playlist, visualizationKey) {
            if (_config2.default.playlists[playlist] != undefined) {
              if (
                _config2.default.visualizations.available[visualizationKey] !=
                undefined
              ) {
                _config2.default.playlists[
                  playlist
          ...
          function setSongInPlaylistVisualization(
            ...
            if (
              _config2.default.playlists[playlist].songs[songIndex] != undefined
            ) {
              if (
                _config2.default.visualizations.available[visualizationKey] !=
                undefined
  ...
  */
      ...
      */
        ...
        */
          ...
          */
                  for (
                    var i = 0;
                    i < _config2.default.playlists[key].songs.length;
                    i++
                  ) {
                    if (
                      _checks2.default.isInt(
                        _config2.default.playlists[key].songs[i]
                      )
                    ) {
                      _config2.default.playlists[key].songs[i] =
                        _config2.default.songs[
    ...
    */
      ...
      */
        ...
        */
          ...
          */
                  if (
                    _soundcloud2.default.isSoundCloudURL(
                      _config2.default.playlists[key].songs[i].url
                    )
                  ) {
                    /*
    ...
    */
            for (var key in _config2.default.playlists) {
              _metaDataElements2.default.setFirstSongInPlaylist(
                _config2.default.playlists[key].songs[0],
                key
              );
            }
          }
  ...
  */
    ...
    */
            var songContainers = document.getElementsByClassName(
    ...
    */
            for (var i = 0; i < songContainers.length; i++) {
              songContainers[i].classList.remove(
    ...
    */
            if (
              ...
              if (
                ...
                var _songContainers = document.querySelectorAll(
                  '.amplitude-song-container[data-amplitude-song-index="' +
                    activeIndex +
                    '"]'
                );
                ...
                for (var _i = 0; _i < _songContainers.length; _i++) {
                  if (
                    !_songContainers[_i].hasAttribute("data-amplitude-playlist")
                  ) {
                    _songContainers[_i].classList.add(
                      "amplitude-active-song-container"
                    );
                  }
                }
              ...
              if (
                ...
                var _songContainers2 = document.querySelectorAll(
                  '.amplitude-song-container[data-amplitude-song-index="' +
                    activePlaylistIndex +
                    '"][data-amplitude-playlist="' +
                    _config2.default.active_playlist +
                ...
                for (var _i2 = 0; _i2 < _songContainers2.length; _i2++) {
                  _songContainers2[_i2].classList.add(
                    "amplitude-active-song-container"
                  );
                }
              }
    ...
    */
            var currentHourSelectors = document.querySelectorAll(
    ...
    */
            for (var i = 0; i < currentHourSelectors.length; i++) {
              var playlist = currentHourSelectors[i].getAttribute(
                "data-amplitude-playlist"
              );
              var songIndex = currentHourSelectors[i].getAttribute(
                "data-amplitude-song-index"
              );
    ...
    Get all of the hour selectors
    */
            var currentHourPlaylistSelectors = document.querySelectorAll(
    ...
    */
            for (var i = 0; i < currentHourPlaylistSelectors.length; i++) {
              var songIndex = currentHourPlaylistSelectors[i].getAttribute(
                "data-amplitude-song-index"
              );
      ...
      */
      ...
      Get all of the hour selectors
      */
              var currentHourSongSelectors = document.querySelectorAll(
      ...
      */
              for (var i = 0; i < currentHourSongSelectors.length; i++) {
                var playlist = currentHourSongSelectors[i].getAttribute(
                  "data-amplitude-playlist"
                );
    ...
    Get all of the hour selectors
    */
            var currentHourPlaylistSongSelectors = document.querySelectorAll(
              '.amplitude-current-hours[data-amplitude-playlist="' +
                _config2.default.active_playlist +
                '"][data-amplitude-song-index="' +
                activePlaylistIndex +
    ...
    */
            var hourSelectors = document.querySelectorAll(
              ".amplitude-current-hours"
            );
    ...
    */
            var currentMinuteSelectors = document.querySelectorAll(
    ...
    */
            for (var i = 0; i < currentMinuteSelectors.length; i++) {
              var playlist = currentMinuteSelectors[i].getAttribute(
                "data-amplitude-playlist"
              );
              var songIndex = currentMinuteSelectors[i].getAttribute(
                "data-amplitude-song-index"
              );
    ...
    Get all of the minute selectors
    */
            var currentMinutePlaylistSelectors = document.querySelectorAll(
    ...
    */
            for (var i = 0; i < currentMinutePlaylistSelectors.length; i++) {
              var songIndex = currentMinutePlaylistSelectors[i].getAttribute(
                "data-amplitude-song-index"
              );
      ...
      */
      ...
      Get all of the minute selectors
      */
              var currentMinuteSongSelectors = document.querySelectorAll(
      ...
      */
              for (var i = 0; i < currentMinuteSongSelectors.length; i++) {
                var playlist = currentMinuteSongSelectors[i].getAttribute(
                  "data-amplitude-playlist"
                );
    ...
    Get all of the minute selectors
    */
            var currentMinutePlaylistSongSelectors = document.querySelectorAll(
              '.amplitude-current-minutes[data-amplitude-playlist="' +
                _config2.default.active_playlist +
                '"][data-amplitude-song-index="' +
                activePlaylistIndex +
    ...
    */
            for (
              var i = 0;
              i < currentMinutePlaylistSongSelectors.length;
              i++
            ) {
    ...
    */
            var minuteSelectors = document.querySelectorAll(
              ".amplitude-current-minutes"
            );
    ...
    */
            var currentSecondSelectors = document.querySelectorAll(
    ...
    */
            for (var i = 0; i < currentSecondSelectors.length; i++) {
              var playlist = currentSecondSelectors[i].getAttribute(
                "data-amplitude-playlist"
              );
              var songIndex = currentSecondSelectors[i].getAttribute(
                "data-amplitude-song-index"
              );
    ...
    Get all of the second selectors
    */
            var currentSecondPlaylistSelectors = document.querySelectorAll(
    ...
    */
            for (var i = 0; i < currentSecondPlaylistSelectors.length; i++) {
              var songIndex = currentSecondPlaylistSelectors[i].getAttribute(
                "data-amplitude-song-index"
              );
      ...
      */
      ...
      Get all of the second selectors
      */
              var currentSecondSongSelectors = document.querySelectorAll(
      ...
      */
              for (var i = 0; i < currentSecondSongSelectors.length; i++) {
                var playlist = currentSecondSongSelectors[i].getAttribute(
                  "data-amplitude-playlist"
                );
    ...
    Get all of the second selectors
    */
            var currentSecondPlaylistSongSelectors = document.querySelectorAll(
              '.amplitude-current-seconds[data-amplitude-playlist="' +
                _config2.default.active_playlist +
                '"][data-amplitude-song-index="' +
                activePlaylistIndex +
    ...
    */
            for (
              var i = 0;
              i < currentSecondPlaylistSongSelectors.length;
              i++
            ) {
    ...
    */
            var secondSelectors = document.querySelectorAll(
              ".amplitude-current-seconds"
            );
    ...
    */
            var currentTimeSelectors = document.querySelectorAll(
    ...
    */
            var timeText = parseInt(time.minutes) + ":" + time.seconds;
            ...
            for (var i = 0; i < currentTimeSelectors.length; i++) {
              var playlist = currentTimeSelectors[i].getAttribute(
                "data-amplitude-playlist"
              );
              var songIndex = currentTimeSelectors[i].getAttribute(
                "data-amplitude-song-index"
              );
    ...
    */
            var timeSelectors = document.querySelectorAll(
              ".amplitude-current-time"
            );
    ...
    */
            for (var i = 0; i < timeSelectors.length; i++) {
              timeSelectors[i].innerHTML = "0:00";
            }
          }
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var DurationCountDownTimeElements = (function () {
          ...
          function sync(countDownTime, songDuration) {
            var timeRemaining = computeTimeRemaining(
              countDownTime,
              songDuration
            );
          ...
          function syncGlobal(timeRemaining) {
            var durationTimeRemainingSelectors = document.querySelectorAll(
              ".amplitude-time-remaining"
            );

            for (var i = 0; i < durationTimeRemainingSelectors.length; i++) {
              var playlist = durationTimeRemainingSelectors[i].getAttribute(
                "data-amplitude-playlist"
              );
              var songIndex = durationTimeRemainingSelectors[i].getAttribute(
                "data-amplitude-song-index"
              );
      ...
      */
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var DurationHourElements = (function () {
           ...
           */
          function syncGlobal(hours) {
            var durationHourSelectors = document.querySelectorAll(
              ".amplitude-duration-hours"
            );

            for (var i = 0; i < durationHourSelectors.length; i++) {
              var playlist = durationHourSelectors[i].getAttribute(
                "data-amplitude-playlist"
              );
              var songIndex = durationHourSelectors[i].getAttribute(
                "data-amplitude-song-index"
              );
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var DurationMinuteElements = (function () {
           ...
           */
          function syncGlobal(minutes) {
            var durationMinuteSelectors = document.querySelectorAll(
              ".amplitude-duration-minutes"
            );

            for (var i = 0; i < durationMinuteSelectors.length; i++) {
              var playlist = durationMinuteSelectors[i].getAttribute(
                "data-amplitude-playlist"
              );
              var songIndex = durationMinuteSelectors[i].getAttribute(
                "data-amplitude-song-index"
              );
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var DurationSecondElements = (function () {
           ...
           */
          function syncGlobal(seconds) {
            var durationSecondSelectors = document.querySelectorAll(
              ".amplitude-duration-seconds"
            );

            for (var i = 0; i < durationSecondSelectors.length; i++) {
              var playlist = durationSecondSelectors[i].getAttribute(
                "data-amplitude-playlist"
              );
              var songIndex = durationSecondSelectors[i].getAttribute(
                "data-amplitude-song-index"
              );
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var DurationTimeElements = (function () {
          ...
          function syncGlobal(durationText) {
            var durationTimeSelectors = document.querySelectorAll(
              ".amplitude-duration-time"
            );

            for (var i = 0; i < durationTimeSelectors.length; i++) {
              var playlist = durationTimeSelectors[i].getAttribute(
                "data-amplitude-playlist"
              );
              var songIndex = durationTimeSelectors[i].getAttribute(
                "data-amplitude-song-index"
              );
          ...
          function resetTimes() {
            ...
            for (var i = 0; i < durationTimeSelectors.length; i++) {
              durationTimeSelectors[i].innerHTML = "0:00";
            }
          }
